...
namespace Jason
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Jason";
        public static string heroName = characterName;

        public static string subclassName = "Afflictor"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Jason, the Afflictor.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Jason",
                _contentFolder: "Jason",
